...
public:
	...
	virtual void Save(ofstream& OutFile, enum Type t);	// Saves the GameObject parameters to the file
	virtual void Load(ifstream& Infile, enum Type t);	// Loads and Reads the GameObject parameters from the file
